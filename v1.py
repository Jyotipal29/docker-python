...
from langchain.agents import AgentExecutor, create_tool_calling_agent, create_openai_tools_agent,create_openai_tools_agent
...
async def main():
    ...
    llm = ChatOpenAI( api_key="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",
                        base_url="https://api.groq.com/openai/v1/",  model="llama3-70b-8192", temperature=0)
